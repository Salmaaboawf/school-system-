...
//   // Apply the date filter to attendance records
//   const filteredAttendanceRecords = attendanceRecords.filter((record) => {
//     if (dateVal) {
//       return new Date(record.timestamp).toISOString().split("T")[0] === dateVal;
//     }
//     return true;
//   });
...
//           {/* Attendance Records */}
//           <div className="overflow-auto mx-10 border shadow">
//             {uniqueDates.map((date, index) => (
//               <div key={index} className="w-full">
//                 <h3 className="font-bold text-lg bg-gray-200 text-deepBlue text-center py-1">
//                   {date}
//                 </h3>
...
//   // Filter dates based on dateVal, if set
//   const filteredDates = dateVal
//     ? uniqueDates.filter((date) => date === dateVal)
//     : uniqueDates;
...
//               ))
//             ) : (
//               <p className="text-center py-4">No records found for this date.</p>
//             )}
//           </div>
//         </div>
//       </div>
...
function ViewAttendance() {
  ...
  // If all filters are empty, use today's date as the default
  const defaultDate = dateVal || (searchTerm === "" && selectedLevel === "" ? getTodayDate() : "");
  ...
  // Filter dates based on dateVal (if set) or defaultDate (today)
  const filteredDates = defaultDate
    ? uniqueDates.filter((date) => date === defaultDate)
    : uniqueDates;
